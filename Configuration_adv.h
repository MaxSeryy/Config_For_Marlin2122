...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Налаштування висоти столу"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  //#define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  //#define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "X додому"
  #define MAIN_MENU_ITEM_1_GCODE "G28 X"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Y додому"
  #define MAIN_MENU_ITEM_2_GCODE "G28 Y"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Z додому"
  #define MAIN_MENU_ITEM_3_GCODE "G28 Z"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "X/Y/Z додому"
  #define MAIN_MENU_ITEM_4_GCODE "G28"
  //#define MAIN_MENU_ITEM_4_CONFIRM

  //X в кінець
  #define MAIN_MENU_ITEM_5_DESC "X в кінець"
  #define MAIN_MENU_ITEM_5_GCODE "G1 X" STRINGIFY(X_MAX_POS) " F2000"
  //#define MAIN_MENU_ITEM_5_CONFIRM

  //Y в кінець
  #define MAIN_MENU_ITEM_6_DESC "Y в кінець"
  #define MAIN_MENU_ITEM_6_GCODE "G1 Y" STRINGIFY(Y_MAX_POS) " F2000"
  //#define MAIN_MENU_ITEM_6_CONFIRM

  //підняти Z на 2 мм
  #define MAIN_MENU_ITEM_7_DESC "Підняти Z на 2 мм"
  #define MAIN_MENU_ITEM_7_GCODE "G91\nG1 Z2 F100\nG90"
  //#define MAIN_MENU_ITEM_7_CONFIRM

  //нагріти стіл та сопло 90 230
  #define MAIN_MENU_ITEM_8_DESC "Нагріти стіл та сопло"
  #define MAIN_MENU_ITEM_8_GCODE "M140 S90\nM104 S230"
